...
from tournament_calculating.views import tournament_calculate, participants_list, participant_details, group_details, add_participant, delete_group_participant, group_sort
